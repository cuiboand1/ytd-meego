...
Item {
    ...
    function setPlaylist(playlistItem) {
        ...
        videoFeed = "http://www.dailymotion.com/playlist/" + playlistItem.id;
        ...
        Item {
            ...
            Rectangle {
                ...
                Grid {
                    ...
                    Text {
                        text: !(playlist == undefined) ? playlist.videoCount : ""
                        color: "grey"
                        elide: Text.ElideRight
                        font.pixelSize: _SMALL_FONT_SIZE
                    }
                    ...
                    Text {
                        text: !(playlist == undefined) ? playlist.updatedDate : ""
                        color: "grey"
                        elide: Text.ElideRight
                        font.pixelSize: _SMALL_FONT_SIZE
                    }
            ...
            PushButton {
                ...
                onButtonClicked: {
                    if (Controller.getMediaPlayer() == "cutetubeplayer") {
                        if ((!videoListModel.loading) && (videoListModel.count > 0) && (!videoListModel.moreResults)) {
                            playPlaylist()
                        }
                        else {
                            messages.displayMessage(qsTr("Loading playlist videos. Please wait"))
